        ...
        if (!$this->datos->vacio() ) {
            ...
            while ($this->datos->no_vacio()) {
                ...
                for ($a=0; $a<count($this->columnas);$a++) {
                    ...
                    $r.=" <td height=19 valign=middle ".(($this->atributos["ver_modificar"]=="")?' onclick="grid_modificar('.$this->datos->valor("id").')" style="cursor:pointer"':"")." ".$css_celda.">&nbsp;".utf8_encode($this->datos->valor($alias))."</td> "."\r\n";
                }
	/*
